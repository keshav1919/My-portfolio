  ...
  return (
    <PageContainer>
      ...
      <section className="settings-grid">
        <Card className="settings-card settings-card--wide"><h2>Theme</h2><p>Choose light, dark or follow the device setting.</p><ThemeSwitch /><div className="theme-preview"><div><span>Current preview</span><strong>{theme === 'dark' ? 'Dark theme' : 'Light theme'}</strong></div><span className="theme-preview__accent" /></div></Card>
